...
public class PaymentController {
  ...
  @ResponseBody
  public CommonResult create(@RequestBody Cc payment) {
  ...
  @ResponseBody
  public CommonResult<Cc> getPaymentById(@PathVariable String id) {
    System.out.println("进来查询");
    Cc payment = paymentService.getPaymentById(id);
  ...
  public Object discovery() {
    ...
    for (ServiceInstance instance : discoveryClient.getInstances("CLOUD-PAYMENT-SERVICE")) {
      ...
      System.out.println(
          instance.getServiceId() + "/t" + instance.getHost() + instance.getPort() + "/t" + instance
              .getUri());
